...
Further practice in crud methods.
...
Add in proper plugins if it makes sense.

Redesign the page colors and various things so the project is no longer a straight copy.
